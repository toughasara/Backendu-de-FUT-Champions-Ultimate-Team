                ...
                <form id="add-player-form" method="POST" action="form.php">
                    ...
                    <div class="static d-none" id="form1">
                        <div class="input-group">
                            ...
                            <input type="number" id="player-rating" class="numerosnot" name="ratingnot" min="10" max="100">
                        </div>
        
                        <div class="input-group">
                            <label for="player-pace">the pace:</label>
                            <input type="number" id="player-pace" class="numerosnot" name="pacing" min="10" max="100">
                        </div>
        
                        <div class="input-group">
                            <label for="player-shooting">the shooting:</label>
                            <input type="number" id="player-shooting" class="numerosnot" name="shooting" min="10" max="100">
                        </div>
        
                        <div class="input-group">
                            <label for="player-passing">the passing:</label>
                            <input type="number" id="player-passing" class="numerosnot" name="passing" min="10" max="100">
                        </div>
        
                        <div class="input-group">
                            <label for="player-dribbling">the dribbling:</label>
                            <input type="number" id="player-dribbling" class="numerosnot" name="dribbling" min="10" max="100">
                        </div>
        
                        <div class="input-group">
                            <label for="player-defending">the defending:</label>
                            <input type="number" id="player-defending" class="numerosnot" name="defending" min="10" max="100">
                        </div>
        
                        <div class="input-group">
                            <label for="player-physical">the physical:</label>
                            <input type="number" id="player-physical" class="numerosnot" name="physical" min="10" max="100">
                        </div>  
                    </div>
                    ...
                    <div class="static d-none" id="form2">
                        <div class="input-group">
                            <label for="player-rating">the rate:</label>
                            <input type="number" id="player-rating" class="numerosgk" name="ratinggk" min="10" max="100">
                        </div>
        
                        <div class="input-group">
                            <label for="player-diving">the diving:</label>
                            <input type="number" id="player-diving" class="numerosgk" name="diving" min="10" max="100">
                        </div>
        
                        <div class="input-group">
                            <label for="player-handling">the handling:</label>
                            <input type="number" id="player-handling" class="numerosgk" name="handling" min="10" max="100">
                        </div>
        
                        <div class="input-group">
                            <label for="player-kicking">the kicking:</label>
                            <input type="number" id="player-kicking" class="numerosgk" name="kicking" min="10" max="100">
                        </div>
        
                        <div class="input-group">
                            <label for="player-reflexes">the reflexes:</label>
                            <input type="number" id="player-reflexes" class="numerosgk" name="reflexes" min="10" max="100">
                        </div>
        
                        <div class="input-group">
                            <label for="player-speed">the speed:</label>
                            <input type="number" id="player-speed" class="numerosgk" name="speed" min="10" max="100">
                        </div>
